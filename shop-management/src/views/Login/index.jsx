      ...
      <Row className='login-row' type='flex' justify='space-around' align='middle'>
        <Col span='8'>
          <Form layout='horizontal' onSubmit={this.handleSubmit.bind(this)} className='login-form'>
            ...
            <p>
              <Button className='btn-login' type='primary' size='large' icon='poweroff' loading={this.state.loading} htmlType='submit'>
                登录
              </Button>
            </p>
            <p>
              <Button className='btn-register' size='large' icon='right-square-o' htmlType='button' onClick={this.toRegister.bind(this)}>
                去注册
              </Button>
            </p>
          </Form>
