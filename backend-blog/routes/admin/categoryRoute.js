...
router.get('/category/get_list_root', categoryController.getListRootCategory)
router.get('/category/get_list_child/:categoryId', categoryController.getListChildCategory)
